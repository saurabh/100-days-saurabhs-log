...
**Link to work**: [Example 1](https://github.com/saurabh/learning-Solidity/blob/master/10.Libraries.sol)
**Link to work**: [Example 2](https://github.com/saurabh/learning-Solidity/blob/master/11.Libraries2.sol)
...
**Link to work**: [Shared Wallet](https://github.com/saurabh/learning-Solidity/blob/master/SharedWallet.sol)
